...
principle_map = {"Open": "{0}/principles/fp-001-open.html".format(host),
                 "Format": "{0}/principles/fp-002-format.html".format(host),
                 "URIs": "{0}/principles/fp-003-uris.html".format(host),
                 "Versioning": "{0}/principles/fp-004-versioning.html".format(host),
                 "Scope": "{0}/principles/fp-005-delineated-content.html".format(host),
                 "Definitions": "{0}/principles/fp-006-textual-definitions.html".format(host),
                 "Relations": "{0}/principles/fp-007-relations.html".format(host),
                 "Documentation": "{0}/principles/fp-008-documented.html".format(host),
                 "Users": "{0}/principles/fp-009-users.html".format(host),
                 "Collaboration": "{0}/principles/fp-010-collaboration.html".format(host),
                 "Authority": "{0}/principles/fp-011-locus-of-authority.html".format(host),
                 "Naming": "{0}/principles/fp-012-naming-conventions.html".format(host),
                 "Maintenance": "{0}/principles/fp-016-maintenance.html".format(host)}
...
def get_html(data):
  ...
  for h in headers:
    ...
    if h in principle_map:
      lines.append('\t\t\t\t<td><b><a href="{0}" target="_blank">{1}</a></b></td>'.format(principle_map[h], h))
    else:
...
<a href="reports/principles/fp7-{0}.tsv">{2}</a></td>'.format(ont, td_class, icon))
        ...
        if icon:
          lines.append('\t\t\t\t<td class="{0}" style="text-align:center">{1}</td>'.format(td_class, icon))
        else:
          lines.append('\t\t\t\t<td class="{0}" style="text-align:center">{1}</td>'.format(td_class, f))
