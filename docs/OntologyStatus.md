...
An ontology can be active, inactive, orphaned and obsolete
...
Please refer to the OBOFoundry GitHub [issue](https://github.com/OBOFoundry/OBOFoundry.github.io/issues/1126) for continued discussions on the subject.
