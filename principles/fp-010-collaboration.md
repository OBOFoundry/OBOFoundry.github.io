...
Additionally, provide a `CONTRIBUTION.md` file to inform community members how to contribute to your projects ([example](https://github.com/mapping-commons/sssom/blob/master/CONTRIBUTING.md), [learn more](http://mozillascience.github.io/working-open-workshop/contributing/)).
