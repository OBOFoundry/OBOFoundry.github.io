...
OBO Foundry Ontologies MUST EITHER be released under a [Creative Common Attribution 3.0 International (CC BY 3.0) license or later](https://creativecommons.org/licenses/by/3.0/) or later, OR released into the public domain under [a Creative Commons CC0 public domain dedication](https://creativecommons.org/publicdomain/zero/1.0/). The license MUST be clearly stated using the http://purl.org/dc/terms/license property followed by the URL representing the license (e.g. https://creativecommons.org/licenses/by/3.0/) in the ontology file ([example](https://github.com/INCATools/ontology-development-kit/blob/master/docs/License.md)).
